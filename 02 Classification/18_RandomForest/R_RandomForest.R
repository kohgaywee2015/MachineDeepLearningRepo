...
classifier <- randomForest(x = training.set[ ,!(colnames(testing.set) == "Purchased")],
                           y = training.set$Purchased,
                           ntree = 10)
...
classifier <- randomForest(x = set[ ,!(colnames(set) == "Purchased")],
                           y = set$Purchased,
                           ntree = 10)
